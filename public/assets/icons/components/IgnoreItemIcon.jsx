...
function IgnoreItemIcon() {
  return (
<svg width="20px" height="20px" viewBox="0 0 1024 1024" fill="#2563eb" className="icon" version="1.1" xmlns="http://www.w3.org/2000/svg">
