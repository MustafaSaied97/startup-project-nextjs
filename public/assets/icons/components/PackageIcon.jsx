...
export default function PackageIcon({size=32}) {
  return (
    <svg width={size} height={size} viewBox='0 0 32 32' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <g id='Duotone/Package'>
        ...
        />
        <path id='Vector_3' d='M22.125 19.0625V12.5625L10 5.875' stroke='#2DB324' strokeWidth={2} strokeLinecap='round' strokeLinejoin='round' />
        <path id='Vector_4' d='M27.8627 9.3252L16.1127 16.0002L4.1377 9.3252' stroke='#2DB324' strokeWidth={2} strokeLinecap='round' strokeLinejoin='round' />
        <path id='Vector_5' d='M16.1125 16L16 29.35' stroke='#2DB324' strokeWidth={2} strokeLinecap='round' strokeLinejoin='round' />
      </g>
    </svg>
  );
}
