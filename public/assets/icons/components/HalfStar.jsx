...
export default function HalfStar({ size = 16 }) {
  return (
    <svg width={size} height={size}  viewBox='-2.8 -2.8 33.60 33.60' fill='none' xmlns='http://www.w3.org/2000/svg' transform='rotate(0)' stroke='#fdc835'>
      <g id='SVGRepo_bgCarrier' strokeWidth={0} transform='translate(6.72,6.72), scale(0.52)' />
      <g id='SVGRepo_tracerCarrier' strokeLinecap='round' strokeLinejoin='round' stroke='#CCCCCC' strokeWidth='0.28' />
