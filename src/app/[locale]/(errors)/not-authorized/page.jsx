    ...
    <section className='bg-white dark:bg-gray-900 '>
      <div className='container mx-auto flex min-h-screen items-center px-6 py-12'>
        <div className='mx-auto flex max-w-sm flex-col items-center text-center'>
          ...
          <h1 className='mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl'>Not Authorized</h1>
          <p className='mt-4 text-gray-500 dark:text-gray-400'>Sorry, You Are Not Allowed to Access This Page.</p>
